...
#define I2C_INTERRUPT_FLAG 7
#define I2C_ENABLE_ACKNOWLEDGE_BIT 6
#define I2C_START_CONDITION_BIT 5
#define I2C_STOP_CONDITION_BIT 4
#define I2C_PRESCALER_TWSR_BIT_0 0
#define I2C_PRESCALER_TWSR_BIT_1 1
#define I2C_GENERAL_CALL_ENABLE_BIT 0
